...
wget https://github.com/laashub-soa/executor-auto-flush-data/archive/refs/tags/v0.0.10.zip
unzip v0.0.10.zip && cd executor-auto-flush-data-0.0.10

docker build -t tanshilindocker/executor-auto-flush-data:0.0.10 -f deploy/Dockerfile .
docker login  --username="" --password=""
docker push  tanshilindocker/executor-auto-flush-data:0.0.10
```
